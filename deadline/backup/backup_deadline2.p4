...
control MyIngress(inout headers hdr,
    ...
    apply{
        ...
        if(meta.broadcast_flag == 0){ // When normal gradient packets
            ...
            if(meta.frame_type == 1){ // When packet is local gradient
                ...
                if(standard_metadata.instance_type != 0){ // If recirculation packet => No processing
                ...
                // TODO: routing to workers
            }

            else{ // Other packets (normal packets)
                ipv4_forward.apply();
            }
        }

        else{ // When deadline (broadcast_flag == 1)
