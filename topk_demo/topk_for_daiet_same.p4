            ...
            { \ 
                if(hdr.preamble.remaining_number_of_entries != 0){ \
                    ...
                    if (is_saved != 1) { \
                        ...
                        hash(register_idx2, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { hdr.entry[##i].key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        ...
                        hash(register_idx3, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        ...
                        hash(register_idx4, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        meta.tree_id_for_hash2 = meta.tree_id + NUMBER_OF_TREES; \
                        hash(register_idx5, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        meta.tree_id_for_hash2 = meta.tree_id + NUMBER_OF_TREES; \
                        hash(register_idx6, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        meta.tree_id_for_hash2 = meta.tree_id + NUMBER_OF_TREES; \
                        hash(register_idx7, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        meta.tree_id_for_hash2 = meta.tree_id + NUMBER_OF_TREES; \
                        hash(register_idx8, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
                    ...
                    if (is_saved != 1) { \
                        meta.tree_id_for_hash2 = meta.tree_id + NUMBER_OF_TREES; \
                        hash(register_idx9, HashAlgorithm.crc32, ((bit<16>)meta.tree_id-1)*NUMBER_OF_CELLS+1, { pushout_key }, NUMBER_OF_CELLS); \
